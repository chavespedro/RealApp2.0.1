...
Partial Public Class Login
    ...
    '''<summary>
    '''Controle logohoteisreal.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
    '''</remarks>
    Protected WithEvents logohoteisreal As Global.System.Web.UI.WebControls.Image
    ...
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
    '''</remarks>
    Protected WithEvents OpenAuthLogin As Global.realapp.OpenAuthProviders
End Class
