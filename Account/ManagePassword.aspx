<%@ Page Title="Gerenciar senha" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="ManagePassword.aspx.vb" Inherits="realapp.ManagePassword" %>
    ...
    <div class="form-horizontal">
        <section id="passwordForm">
            <asp:PlaceHolder runat="server" ID="setPassword" Visible="false">
                <p>
                    Você não possui uma senha local para esse site, Adicione uma senha
                        local para que você possa fazer logon sem um logon externo.
                </p>
                <div class="form-horizontal">
